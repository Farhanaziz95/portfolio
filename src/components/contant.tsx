                    ...
                    <form>
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <textarea placeholder='Write Your Message' id="about" name="about" rows={3} className="block w-full rounded-full px-8 border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
                                </div>
                        ...
                        <div className="mt-6 flex items-center justify-center gap-x-6">
                            ...
                            <button type="submit" className="rounded-full w-full bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
