        ...
        <section id='HeroSection' style={{ backgroundImage: 'url(/bghero.jpg)' }} className=" bg-cover bg-center bg-no-repeat bg-fixed dark:invert dark:bg-gray-900">
            <div className=" dark:invert grid max-w-screen-xl px-20 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <a href="#" className="text-black dark:text-white inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Download My CV
